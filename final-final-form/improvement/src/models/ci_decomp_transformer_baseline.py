"""Channel-Independent Decomposed Transformer (no overlapping patches).

Same architecture as ci_decomp_transformer.py — this variant exists for
ablation comparison against the overlapping-patches version.
"""
