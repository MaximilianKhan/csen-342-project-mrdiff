"""CI+Decomp Transformer with Attention Residuals (Exp 26 + overlapping patches).
...
class CIAttnResDecompTransformer(nn.Module):
    ...
    - Optional overlapping patches (patch_stride < patch_size)
    """
    ...
    def __init__(
        ...
        # patch_stride=None → no overlap (original behaviour)
