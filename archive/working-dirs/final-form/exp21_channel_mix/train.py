#!/usr/bin/env python3
"""Exp 21: CI+Decomp Transformer + Cross-Channel Mixing."""
import torch, torch.nn as nn, yaml, time
from src.data.dataset import create_dataloaders
from src.models.ci_channel_mix import CIChannelMixTransformer
...
def create_model(cfg, D, H, L):
    ps = cfg["patch_size"]
    while L // ps < 4: ps //= 2
    return CIChannelMixTransformer(input_dim=D, forecast_length=H, lookback_length=L,
...
def main():
    print("EXP 21: CI+Decomp + Cross-Channel Mixing")
