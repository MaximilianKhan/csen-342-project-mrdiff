#!/usr/bin/env python3
"""Train Tiny Transformer (Exp 15) — direct forecasting, no diffusion.
...
from src.models.tiny_transformer import create_model
...
def main():
    print("=" * 70)
    print("EXP 15: Tiny Transformer (PatchTST-style, no diffusion)")
    print("=" * 70)
