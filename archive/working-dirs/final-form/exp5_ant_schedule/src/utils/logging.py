...
Provides TensorBoard and JSONL logging for training metrics.
"""
...
class TrainingLogger:
    ...
    Supports TensorBoard and JSONL logging formats.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            use_csv: Whether to use JSONL metrics logging.
        """
        ...
        # Metrics file (JSONL format — one JSON object per line)
