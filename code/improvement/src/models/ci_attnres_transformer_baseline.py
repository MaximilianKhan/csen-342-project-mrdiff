"""CI+Decomp Transformer with Attention Residuals (no overlapping patches).

Same as ci_attnres_transformer.py — non-overlapping patch variant for
ablation comparison.
"""
...
class CIAttnResDecompTransformer(nn.Module):
    """CI+Decomp+AttnRes with non-overlapping patches."""
