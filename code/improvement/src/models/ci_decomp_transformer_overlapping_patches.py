"""Channel-Independent Decomposed Transformer with overlapping patches.

patch_stride < patch_size creates 50% overlap via torch.unfold, doubling
the token count for short lookbacks (e.g. ETTh1: 42 -> 83 tokens).
"""
