#!/usr/bin/env python3
"""Train CI Transformer (Exp 16) — direct forecasting, no diffusion.
...
from src.models.ci_transformer import create_model
...
def main():
    print("=" * 70)
    print("EXP 16: CI Transformer (channel-independent, no diffusion)")
    print("=" * 70)
