#!/usr/bin/env python3
"""Experiment 10: Direct x0-prediction with Decomposition (Diffusion-TS).

Denoiser outputs trend + seasonality that sum to x0, trained with direct MSE on x0.
"""
...
def main():
    print("=" * 70)
    print("FINAL TRAINING: Residual Diffusion (small model)")
    print("=" * 70)
